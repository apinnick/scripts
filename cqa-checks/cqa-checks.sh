...
**Criteria followed by \*\* are 'Required\/non-negotiable'.** Criteria required for DITA migration are also 'Required\/non-negotiable'.
\n\nFor details, see the [Modular documentation templates checklist](https://docs.google.com/document/d/13NAUVAby1y1qfT77QFIZrMBhi872e7IEvAC9MUpGXbQ/edit?tab=t.0) and [TEMPLATE -- Content Quality Assessment](https://docs.google.com/spreadsheets/d/11LyS_q40rF0IQ0p-U-ZG1legKHB7dKbv8Kn279wqvpA/edit?usp=sharing).\n\n" >> $OUTPUT
echo -e "This report is generated by the [cqa-checks](https://github.com/apinnick/scripts/blob/main/cqa-checks/cqa-checks.sh) script. It is a work on progress and may contain errors. Please send feedback to [Avital Pinnick](mailto:apinnick@redhat.com).\n" >> $OUTPUT
